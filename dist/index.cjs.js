...
function useCounter(ref, actions) {
    const compiled = React__namespace.useMemo(() => ({
...
function useCounterRoot(ref) {
    React__namespace.useLayoutEffect(() => trackRoot(ref.current), [ref]);
}
    ...
    constructor(options) {
        ...
        this.negative = negative == null
            ...
            : typeof negative === 'string'
                ...
                : negative;
        this.range = {
            min: (range === null || range === void 0 ? void 0 : range.min) || system.range.min,
            max: (range === null || range === void 0 ? void 0 : range.max) || system.range.max,
        };
        this.pad = pad;
        ...
        if (this.pad != null) {
            ...
            if (value < 0) {
                length -= this.negative.prefix.length
                    + ((_a = this.negative.suffix) === null || _a === void 0 ? void 0 : _a.length) || 0;
            }
            if (length > 0) {
...
function useCounters(ref) {
    const [state, setState] = React__namespace.useState(new Map());
    React__namespace.useLayoutEffect(() => {
        const node = ref == null
            ? null
            : ref instanceof Node
...
function useCounterValue(ref, counter, style) {
    ...
    React__namespace.useDebugValue(value);
    return style == null
        ? value
...
function useCounterValues(ref, counter, style, separator) {
    ...
    React__namespace.useDebugValue(values);
    return style == null
        ? values
...
exports.useCounterRoot = useCounterRoot;
exports.useCounterValue = useCounterValue;
exports.useCounterValues = useCounterValues;
exports.useCounters = useCounters;
